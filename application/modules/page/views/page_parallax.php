<ul id="nav">
	<li><a href="#intro" title="Next Section"><img src="<?php echo assets_url('images/parallax/dot.png'); ?>" alt="Link" /></a></li>
	<li><a href="#second" title="Next Section"><img src="<?php echo assets_url('images/parallax/dot.png'); ?>" alt="Link" /></a></li>
	<li><a href="#third" title="Next Section"><img src="<?php echo assets_url('images/parallax/dot.png'); ?>" alt="Link" /></a></li>
	<li><a href="#fifth" title="Next Section"><img src="<?php echo assets_url('images/parallax/dot.png'); ?>" alt="Link" /></a></li>
</ul>
