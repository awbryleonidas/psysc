	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?php echo site_url(); ?>" class="logo">
				...
				<span class="logo-lg"><span class="fa fa-fire"></span> <?php echo $this->config->item('cms_title'); ?></span>
			</a>
								...
								<li>
									...
									<ul class="menu">
										<li><!-- start message -->
											<a href="#">
												<div class="pull-left">
													<img src="<?php echo assets_url('themes/adminlte/img/user2-160x160.jpg'); ?>" class="img-circle" alt="User Image"/>
												</div>
												<h4>
													Support Team
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">
						...
						<span class="sr-only">Cloase</span>
					</button>
