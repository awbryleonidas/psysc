...
class {{ucf_plural_module_name}} extends MX_Controller 
{
	...
	function __construct()
	{
		...
		$this->load->model('{{lc_plural_module_name}}_model');
	...
	public function index()
	{
		...
		// render the page
		$this->template->add_css(module_css('{{parent_module}}', '{{lc_plural_module_name}}_index'));
		$this->template->add_js(module_js('{{parent_module}}', '{{lc_plural_module_name}}_index'));
...
{{controller_form_errors}}				);
		...
		$this->template->add_css(module_css('{{parent_module}}', '{{lc_plural_module_name}}_form'));
		$this->template->add_js(module_js('{{parent_module}}', '{{lc_plural_module_name}}_form'));
