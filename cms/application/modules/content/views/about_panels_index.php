	...
	<div class="col-md-12">
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label" for="about_us_panel_name_3">Panel 3:</label>
					<?php $formdata = array('id'=>'about_us_panel_name_3', 'name'=>'about_us_panel_name_3', 'value'=>set_value('about_us_panel_name_3', isset($config['about_us_panel_name_3']) ? $config['about_us_panel_name_3'] : ''), 'class'=>'form-control'); ?>
					<div class="col-sm-8">
						<?php echo form_input($formdata); ?>
						<div class="help-text"><?=lang('text_about_us_panel_name_3')?></div>
						<?php echo form_error('about_us_panel_name_3'); ?>
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-4 control-label" for="about_us_panel_text_3">Panel 3 Text:</label>
					<?php $formdata = array('id'=>'about_us_panel_text_3', 'name'=>'about_us_panel_text_3', 'value'=>set_value('about_us_panel_text_3', isset($config['about_us_panel_text_3']) ? $config['about_us_panel_text_3'] : ''), 'class'=>'form-control', 'rows'=>'2'); ?>
					<div class="col-sm-8">
						<?php echo form_textarea($formdata); ?>
						<?php echo form_error('about_us_panel_text_3'); ?>
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-4 control-label" for="about_us_panel_name_4">Panel 4:</label>
					<?php $formdata = array('id'=>'about_us_panel_name_4', 'name'=>'about_us_panel_name_4', 'value'=>set_value('about_us_panel_name_4', isset($config['about_us_panel_name_4']) ? $config['about_us_panel_name_4'] : ''), 'class'=>'form-control'); ?>
					<div class="col-sm-8">
						<?php echo form_input($formdata); ?>
						<div class="help-text"><?=lang('text_about_us_panel_name_4')?></div>
						<?php echo form_error('about_us_panel_name_4'); ?>
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-4 control-label" for="about_us_panel_text_4">Panel 4 Text:</label>
					<?php $formdata = array('id'=>'about_us_panel_text_4', 'name'=>'about_us_panel_text_4', 'value'=>set_value('about_us_panel_text_4', isset($config['about_us_panel_text_4']) ? $config['about_us_panel_text_4'] : ''), 'class'=>'form-control', 'rows'=>'2'); ?>
					<div class="col-sm-8">
						<?php echo form_textarea($formdata); ?>
						<?php echo form_error('about_us_panel_text_4'); ?>
					</div>
				</div>
