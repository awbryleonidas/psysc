		...
		[
			{
				...
				"mRender": function (data, type, full) {
					...
					return '<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">' +
						...
						'<div class="media-body"><strong>' + full[2] + '</strong><div class="feed_location">' +
						'<span class="fa fa-map-marker"></span> Mall Location<span class="hidden-md hidden-sm pull-right">'
						+ timeago +' ago</span></div></div></div></div>' +

						'<div class="thumbnail' + status + '"><a data-toggle="modal" data-target="#modal" href="feeds/edit/' + full[0] + '">' +
						'<img src="' + asset_url + data + '" class="img-responsive" width="100%" /></a><div class="caption caption-text"><p>' + full[3] + '</p></div></div><a data-toggle="modal" data-target="#modal" href="feeds/delete/' + full[0] + '">Delete</a></div></div>';
				},
			},
