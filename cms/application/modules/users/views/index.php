<div class="box">
	...
	<div class="box-body">
		...
		<p><?php echo anchor('users/create_user', lang('index_create_user_link'), 'class="btn btn-primary"')?> <?php //echo anchor('users/create_group', lang('index_create_group_link'), 'class="btn btn-primary"')?></p>
