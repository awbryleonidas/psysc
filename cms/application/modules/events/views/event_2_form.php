	...
	<div class="form-horizontal">
		...
		<div class="row">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label" for="event_highlight_image_2">Image 1:</label>
				<div class="col-sm-4">
					<?php echo form_open(site_url('events/event_2/upload'), array('class'=>'dropzone', 'id' => 'dropzone3'));?>
					<input type="file" name="file" class="hide" />
					<?php echo form_close();?>
					<div id="error_event_highlight_image_2"></div>
				</div>
				<div class="col-sm-5">
					<?php if (isset($record['event_highlight_image_2'])): ?>
						<img src="<?php echo site_url($record['event_highlight_image_2']); ?>" width="120" />
					<?php endif; ?>
				</div>
			</div>

			<div class="form-group hide">
				<label class="col-sm-2 control-label" for="event_highlight_image_2">Hide This:</label>
				<div class="col-sm-9">
					<?php echo form_input(array('id'=>'event_highlight_image_2', 'name'=>'event_highlight_image_2', 'value'=>set_value('event_highlight_image_2', isset($record['event_highlight_image_2']) ? $record['event_highlight_image_2'] : ''), 'class'=>'form-control'));?>
				</div>
			</div>
		</div>
	</div>
...
$(function(){
   ...
   var myDropzone3 = new Dropzone("#dropzone3");
	myDropzone3.on("success", function(file, response) {
		...
		$('#event_highlight_image_2').val(o.image);
	});
	...
	$('#submit').click(function(e){
		...
		$(ajax_load).load(ajax_url, {
			'event_highlight_image_2': $('#event_highlight_image_2').val(),
		}, function(data){
